...
Blockly.Blocks['do_while_not_finished'] = {
	init: function() {
		this.appendDummyInput()       
			...
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/cycle-arrows.png', 25, 25, '*'));
...
Blockly.Blocks['if_next_tile_is'] = {
	init: function() {
		this.appendDummyInput()       
			...
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/refresh.png', 25, 25, '*'));
		this.appendStatementInput('NAME')
			.setCheck(null);
		this.setInputsInline(false);
		this.setPreviousStatement(true, null); 
...
Blockly.Blocks['move_forward'] = {
	init: function() {
		this.appendDummyInput()
			...
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/resize-corners.png', 20, 20, '*'));		
...
Blockly.Blocks['rotate_character_left'] = {
	init: function() {
		this.appendDummyInput()
			...
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/rotate-left.png', 20, 20, '*'));		
		this.setPreviousStatement(true, 'Action');
		this.setNextStatement(true, 'Action');
		this.setColour(160);
...
Blockly.Blocks['rotate_character_right'] = {
	init: function() {
		this.appendDummyInput()
			...
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/rotate-right.png', 20, 20, '*'));		
		this.setPreviousStatement(true, 'Action');
		this.setNextStatement(true, 'Action');
		this.setColour(160);
...
Blockly.Blocks['move_right'] = {
	init: function() {
		this.appendDummyInput()
			...
			.appendField('doprava')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/right-block.png', 20, 20, '*'));
		this.setPreviousStatement(true, 'Action');
		this.setNextStatement(true, 'Action');
		this.setColour(160);
...
Blockly.Blocks['move_left'] = {
	init: function() {
		this.appendDummyInput()
			...
			.appendField(new Blockly.FieldNumber('1'), 'steps')
			.appendField('doľava')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/left-block.png', 20, 20, '*'));
		this.setPreviousStatement(true, 'Action');
		this.setNextStatement(true, 'Action');
		this.setColour(160);
...
Blockly.Blocks['move_up'] = {
	init: function() {
		this.appendDummyInput()
			...
			.appendField(new Blockly.FieldNumber('1'), 'steps')
			.appendField('hore')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/up-block.png', 20, 20, '*'));       
		this.setPreviousStatement(true, 'Action');
		this.setNextStatement(true, 'Action');
		this.setColour(160);
...
Blockly.Blocks['move_down'] = {
	init: function() {
		this.appendDummyInput()
			...
			.appendField(new Blockly.FieldNumber('1'), 'steps')
			.appendField('dole')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/down-block.png', 20, 20, '*'));
		this.setPreviousStatement(true, 'Action');
		this.setNextStatement(true, 'Action');
		this.setColour(160);
...
Blockly.Blocks['attack'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('zaútoč')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/sword.png', 30, 30, '*'))
...
Blockly.Blocks['use'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('použi')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/lever.png', 30, 30, '*'))
...
Blockly.Blocks['open'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('otvor')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/chest.png', 30, 30, '*'))
			.appendField(new Blockly.FieldDropdown([['napravo','right'], ['naľavo','left'], ['hore','up'], ['dole','down']]), 'direction');
		this.setPreviousStatement(true, 'Action');
		this.setNextStatement(true, 'Action');
		this.setColour(160);	
...
Blockly.Blocks['jump'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('skoč')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/trampoline-park-filled.png', 20, 20, '*'))
			.appendField(new Blockly.FieldDropdown([['doprava','right'], ['doľava','left'], ['hore','up'], ['dole','down']]), 'direction');
		this.setPreviousStatement(true, 'Action');
		this.setNextStatement(true, 'Action');
		this.setColour(160);
...
Blockly.Blocks['player'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('Hrdina  ')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/logo-head-small.png', 70, 70, '*'));   
		this.setNextStatement(true, 'Action');
		this.setColour(300);	
...
Blockly.Blocks['playerDirection'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('Hrdina  ')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/logo-head-small.png', 70, 70, '*'))		
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/nodirection.png', 70, 70, '*'),'facingDirection_image');   
		this.setNextStatement(true, 'Action');
		this.setColour(300);
...
Blockly.Blocks['run'] = {
	init: function() {
		this.appendDummyInput()
			...
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/arrow.png', 70, 70, '*'));   
		this.setColour(100);	
...
Blockly.Blocks['cameraplus'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('Camera+  ')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/plus.png', 70, 70, '*'));   
		this.setColour(95);
...
Blockly.Blocks['cameraminus'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('Camera-  ')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/minus.png', 70, 70, '*'));   
		this.setColour(95);
...
Blockly.Blocks['load'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('Load  ')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/load.png', 70, 70, '*'));   
		this.setColour(95);
...
Blockly.Blocks['save'] = {
	init: function() {
		this.appendDummyInput()
			.appendField('Save  ')
			.appendField(new Blockly.FieldImage(app.$global.Url() + 'game/save.png', 70, 70, '*'));   
		this.setColour(95);

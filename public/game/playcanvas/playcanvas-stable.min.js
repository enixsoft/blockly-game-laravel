;(function (root, factory) {
  ...
  /*
 PlayCanvas Engine v1.12.0 revision adfbd98
 http://playcanvas.com
 Copyright 2011-2018 PlayCanvas Ltd. All rights reserved.
*/
var _typeLookup=function(){for(var e={},b="Array Object Function Date RegExp Float32Array".split(" "),a=0;a<b.length;a++)e["[object "+b[a]+"]"]=b[a].toLowerCase();return e}(),pc={version:"1.12.0",revision:"adfbd98",config:{},common:{},apps:{},data:{},unpack:function(){console.warn("pc.unpack has been deprecated and will be removed shortly. Please update your code.")},makeArray:function(e){var b,a=[],c=e.length;for(b=0;b<c;++b)a.push(e[b]);return a},type:function(e){if(null===
...
this.device,c,d=a._renderedRt,f=a._renderedByCam,g=a._renderedLayer,l,e,k,h,p,n,m,q;this.beginLayers(a);a._update()&pc.COMPUPDATED_LIGHTS&&(this.scene.updateLitShaders=!0);this.beginFrame(a);this.setSceneConstants();var t=0,r,v;for(l=0;l<a.layerList.length;l++)if(e=a.layerList[l],e.enabled&&a.subLayerEnabled[l])for(k=a.subLayerList[l],r=e.instances,h=e.cameras,p=0;p<h.length;p++)if(c=h[p]){c.frameBegin(e.renderTarget);v=k?e.transparentMeshInstances:e.opaqueMeshInstances;q=m=!1;for(n=0;n<t;n++)if(f[n]===
c&&(m=!0,g[n]===e)){q=!0;break}m||(this.updateCameraFrustum(c.camera),this._camerasRendered++);q||this.cullLights(c.camera,e._lights);m&&q||(f[t]=c,g[t]=e,t++);n=k?r.visibleTransparent[p]:r.visibleOpaque[p];if(!n.done){if(e.onPreCull)e.onPreCull(p);n.length=this.cull(c.camera,v,n.list);n.done=!0;if(e.onPostCull)e.onPostCull(p)}c.frameEnd()}for(l=0;l<a._lights.length;l++)c=a._lights[l],c.visibleThisFrame&&c._type!==pc.LIGHTTYPE_DIRECTIONAL&&c.castShadows&&c._enabled&&c.shadowUpdateMode!==pc.SHADOWUPDATE_NONE&&
...
function(a,d){if(a)b(a);else{var f=d.application_properties,g=d.scenes,e=d.assets;c._parseApplicationProperties(f,function(a){c._onVrChange(f.vr);c._parseScenes(g);c._parseAssets(e);a?b(a):b(null)})}})},preload:function(a){var c=this,d,e;c.fire("preload:start");var k=this.assets.list({preload:!0}),p=new b(k.length),h=!1,n=function(){c.graphicsDevice&&!h&&p.done()&&(h=!0,c.fire("preload:end"),a())};e=k.length;if(p.length){var q=function(a){p.inc();c.fire("preload:progress",p.count/e);p.done()&&n()},
m=function(a,b){p.inc();c.fire("preload:progress",p.count/e);p.done()&&n()};for(d=0;d<k.length;d++)k[d].loaded?(p.inc(),c.fire("preload:progress",p.count/e),p.done()&&n()):(k[d].once("load",q),k[d].once("error",m),this.assets.load(k[d]))}else n()},getSceneUrl:function(a){return(a=this._sceneRegistry.find(a))?a.url:null},loadSceneHierarchy:function(a,b){this._sceneRegistry.loadSceneHierarchy(a,b)},loadSceneSettings:function(a,b){this._sceneRegistry.loadSceneSettings(a,b)},loadScene:function(a,b){this._sceneRegistry.loadScene(a,
b)},_preloadScripts:function(a,c){if(pc.script.legacy){var d=this;d.systems.script.preloading=!0;var f=this._getScriptReferences(a),e=0,p=f.length,h=new b(p),n,q=/^http(s)?:\/\//;if(p)for(var m=function(a,b){a&&console.error(a);h.inc();h.done()&&(d.systems.script.preloading=!1,c())},e=0;e<p;e++)n=f[e],!q.test(n.toLowerCase())&&d._scriptPrefix&&(n=pc.path.join(d._scriptPrefix,f[e])),this.loader.load(n,"script",m);else d.systems.script.preloading=!1,c()}else c()},_parseApplicationProperties:function(a,
...
_setLocalPosition:function(a,b,c){a instanceof pc.Vec3?this.localPosition.copy(a):this.localPosition.set(a,b,c);a=this.element;b=this.localPosition;c=a._pivot;a._margin.x=b.x-a._calculatedWidth*c.x;a._margin.z=a._localAnchor.z-a._localAnchor.x-a._calculatedWidth-a._margin.x;a._margin.y=b.y-a._calculatedHeight*c.y;a._margin.w=a._localAnchor.w-a._localAnchor.y-a._calculatedHeight-a._margin.y;this._dirtyLocal||this._dirtifyLocal()},_sync:function(){var f=this.element,g=f.screen;if(g){if(f._anchorDirty){var h,
l,q=0,m=1;this._parent&&this._parent.element?(h=this._parent.element.calculatedWidth,l=this._parent.element.calculatedHeight,q=this._parent.element.pivot.x,m=this._parent.element.pivot.y):(l=g.screen.resolution,h=l.x/g.screen.scale,l=l.y/g.screen.scale);f._anchorTransform.setTranslate(h*(f.anchor.x-q),-(l*(m-f.anchor.y)),0);f._anchorDirty=!1;f._calculateLocalAnchors()}f._sizeDirty&&f._calculateSize()}this._dirtyLocal&&(this.localTransform.setTRS(this.localPosition,this.localRotation,this.localScale),
...
b){if(a){console.error(a);if(this._requests[e])for(var c=0,g=this._requests[e].length;c<g;c++)this._requests[e][c](a);delete this._requests[e]}else f.load(b,function(a,c,g){if(this._requests[e]){var l=this._requests[e].length,h;if(!a)try{h=f.open(b.original,c,d)}catch(y){a=y}if(a)for(console.error(a),c=0;c<l;c++)this._requests[e][c](a);else for(this._cache[e]=h,c=0;c<l;c++)this._requests[e][c](null,h,g);delete this._requests[e]}}.bind(this),d)}.bind(this);a=b.split("?")[0];this._app.enableBundles&&
...
c._worker.untar(b,function(b,d){a(b,d);c._worker.hasPendingRequests()||(c._worker.destroy(),c._worker=null)});else{var d=(new pc.Untar(b)).untar(c._assets.prefix);a(null,d)}},open:function(b,a){return new pc.Bundle(a)},patch:function(b,a){}});return{BundleHandler:e}}());Object.assign(pc,function(){function e(a){function c(a){this._fields=a}var d,e;"undefined"!==typeof TextDecoder?(d=new TextDecoder("utf-8"),e=new TextDecoder("windows-1252")):console.warn("TextDecoder not supported - pc.Untar module will not work");c.parse=function(a,b,f){for(var e=new Uint8Array(a,b,f),g=0,l=[];g<f;){var h;for(h=g;h<f&&32!=e[h];h++);if(h>=f)throw Error("Invalid PAX header data format.");var k=parseInt(d.decode(new Uint8Array(a,b+g,h-g)),10);h=d.decode(new Uint8Array(a,b+h+1,k-(h-
...
k);k.prototype._hasNext=function(){return this._bytesRead+4<this._arrayBuffer.byteLength&&0!==this._bufferView.getUint32(this._bytesRead)};k.prototype._readNextFile=function(){var b=new DataView(this._arrayBuffer,this._bytesRead,512),d=e.decode(b);this._bytesRead+=512;var b=d.substr(0,100).replace(/\0/g,""),f=d.substr(257,6),g=parseInt(d.substr(124,12),8),l=d.substr(156,1),k=this._bytesRead,t=null,v,y=!1;switch(l){case "0":case "":y=!0;a||(t=new Blob([this._arrayBuffer.slice(this._bytesRead,this._bytesRead+
g)]),t=URL.createObjectURL(t));break;case "g":this._globalPaxHeader=c.parse(this._arrayBuffer,this._bytesRead,g);break;case "x":v=c.parse(this._arrayBuffer,this._bytesRead,g)}this._bytesRead+=g;l=g%512;0!==l&&(this._bytesRead+=512-l);if(!y)return null;-1!==f.indexOf("ustar")&&(d=d.substr(345,155).replace(/\0/g,""),0<d.length&&(b=d.trim()+b.trim()));b={name:b,start:k,size:g,url:t};this._globalPaxHeader&&this._globalPaxHeader.applyHeader(b);v&&v.applyHeader(b);return b};k.prototype.untar=function(a){if(!d)return console.error("Cannot untar because TextDecoder interface is not available for this platform."),
[];for(var b=[];this._hasNext();){var c=this._readNextFile();c&&(a&&c.name&&(c.name=a+c.name),b.push(c))}return b};a&&(self.onmessage=function(a){var b=a.data.id;try{var c=(new k(a.data.arrayBuffer)).untar(a.data.prefix);postMessage({id:b,files:c,arrayBuffer:a.data.arrayBuffer},[a.data.arrayBuffer])}catch(q){postMessage({id:b,error:q.toString()})}})}var b,a=function(){var a=new Blob(["("+e.toString()+")(true)\n\n"],{type:"application/javascript"});return URL.createObjectURL(a)}(),c=function(b){this._requestId=
0;this._pendingRequests={};this._filenamePrefix=b;this._worker=new Worker(a);this._worker.addEventListener("message",this._onMessage.bind(this))};c.prototype._onMessage=function(a){var b=a.data.id;if(this._pendingRequests[b]){var c=this._pendingRequests[b];delete this._pendingRequests[b];if(a.data.error)c(a.data.error);else{for(var b=a.data.arrayBuffer,d=0,e=a.data.files.length;d<e;d++){var p=a.data.files[d],h=new Blob([b.slice(p.start,p.start+p.size)]);p.url=URL.createObjectURL(h)}c(null,a.data.files)}}};
...
HTMLImageElement)c=".jpg"===d||".jpeg"===d?pc.PIXELFORMAT_R8_G8_B8:pc.PIXELFORMAT_R8_G8_B8_A8,c=new pc.Texture(this._device,{width:b.width,height:b.height,format:c}),c.name=a,c.setSource(b);else if(b instanceof ArrayBuffer)if(".dds"===d){c=b;var e=this._device;if(".crn"===pc.path.getExtension(a).toLowerCase()){var d=c.byteLength,k=new Uint8Array(c);c=Module._malloc(d);var p=Module.HEAPU8,h,n=c/4,q=d%4,m=new Uint32Array(k.buffer,0,(d-q)/4),r=new Uint32Array(p.buffer);for(h=0;h<m.length;h++)r[n+h]=
...
pc.http.get(a.load,function(d,f){var g=e(f);d?b(pc.string.format("Error loading font resource: {0} [{1}]",a.original,d)):c._loadTextures(a.original.replace(".json",".png"),g,function(a,c){if(a)return b(a);b(null,{data:g,textures:c})})}):(d&&d.data&&(d.data=e(d.data)),this._loadTextures(a.original,d&&d.data,b))},_loadTextures:function(a,b,d){var c=b.info.maps.length,e=0,l=null,k=Array(c),p=this._loader;b=function(b){var f=function(a,f){if(!l){if(a)return l=a,d(a);f.upload();k[b]=f;e++;e===c&&d(null,
k)}};0===b?p.load(a,"texture",f):p.load(a.replace(".png",b+".png"),"texture",f)};for(var h=0;h<c;h++)b(h)},open:function(a,b,d){return b.textures?new pc.Font(b.textures,b.data):new pc.Font(b,null)},patch:function(a,b){var c=a.resource;!c.data&&a.data?c.data=a.data:!a.data&&c.data&&(a.data=c.data)}});return{FontHandler:b}}());Object.assign(pc,function(){var e={repeat:pc.ADDRESS_REPEAT,clamp:pc.ADDRESS_CLAMP_TO_EDGE,mirror:pc.ADDRESS_MIRRORED_REPEAT},b={nearest:pc.FILTER_NEAREST,linear:pc.FILTER_LINEAR,nearest_mip_nearest:pc.FILTER_NEAREST_MIPMAP_NEAREST,linear_mip_nearest:pc.FILTER_LINEAR_MIPMAP_NEAREST,nearest_mip_linear:pc.FILTER_NEAREST_MIPMAP_LINEAR,linear_mip_linear:pc.FILTER_LINEAR_MIPMAP_LINEAR},a=/^data\.frames\.(\d+)$/,c=function(a){this._loader=a};Object.assign(c.prototype,{load:function(a,b){"string"===typeof a&&
...
b,f,e,l,k,p){a=a.model;var c=[],d;for(d=0;d<a.meshInstances.length;d++){var g=a.meshInstances[d],m=f[g.mesh],g=new pc.MeshInstance(b[g.node],m,this._defaultMaterial);if(m.skin){var r=e.indexOf(m.skin);g.skinInstance=l[r]}m.morph&&(m=k.indexOf(m.morph),g.morphInstance=p[m]);c.push(g)}return c}});return{JsonModelParser:a}}());Object.assign(pc,function(){var e=function(b){this._app=b};Object.assign(e.prototype,{parse:function(b){var a={},c,d,f=null;for(c in b.entities)a[c]=this._createEntity(b.entities[c]),null===b.entities[c].parent&&(f=a[c]);for(c in b.entities){var e=b.entities[c].children.length;for(d=0;d<e;d++){var l=b.entities[c].children[d];a[l]&&a[c].addChild(a[l])}}this._openComponentData(f,b.entities);return f},_createEntity:function(b){var a=new pc.Entity,c=b.position,d=b.rotation,f=b.scale;a.name=b.name;a.setGuid(b.resource_id);
a.setLocalPosition(c[0],c[1],c[2]);a.setLocalEulerAngles(d[0],d[1],d[2]);a.setLocalScale(f[0],f[1],f[2]);a._enabled=void 0!==b.enabled?b.enabled:!0;a._enabledInHierarchy=a._enabled;a.template=b.template;if(b.tags)for(c=0;c<b.tags.length;c++)a.tags.add(b.tags[c]);b.labels&&b.labels.forEach(function(b){a.addLabel(b)});return a},_openComponentData:function(b,a){var c=this._app.systems.list,d,f=c.length,e=a[b.getGuid()];for(d=0;d<f;d++){var l=c[d],k=e.components[l.id];k&&l.addComponent(b,k)}f=e.children.length;
c=b._children;for(d=0;d<f;d++)c[d]=this._openComponentData(c[d],a);return b}});return{SceneParser:e}}());Object.assign(pc,function(){var e=function(){this._validator=null};e.prototype.parse=function(b){b=this.migrate(b);b=this._validate(b);var a=new pc.StandardMaterial;this.initialize(a,b);return a};e.prototype.initialize=function(b,a){a.validated||(this._validator||(this._validator=new pc.StandardMaterialValidator),this._validator.validate(a));a.chunks&&b.chunks.copy(a.chunks);for(var c in a){var d=pc.StandardMaterial.PARAMETER_TYPES[c],f=a[c];"vec2"===d?b[c]=new pc.Vec2(f[0],f[1]):"rgb"===d?b[c]=new pc.Color(f[0],
f[1],f[2]):"texture"===d?f instanceof pc.Texture?b[c]=f:b[c]instanceof pc.Texture&&"number"===typeof f&&0<f||(b[c]=null):"cubemap"===d?f instanceof pc.Texture?b[c]=f:b[c]instanceof pc.Texture&&"number"===typeof f&&0<f||(b[c]=null):"boundingbox"===d?(d=new pc.Vec3(f.center[0],f.center[1],f.center[2]),f=new pc.Vec3(f.halfExtents[0],f.halfExtents[1],f.halfExtents[2]),b[c]=new pc.BoundingBox(d,f)):b[c]=a[c]}b.update()};e.prototype.migrate=function(b){void 0===b.shadingModel&&(b.shadingModel="blinn"===
